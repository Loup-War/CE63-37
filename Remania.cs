...
public class Remania : MonoBehaviour
{
    ...
    {
        if (remaniaevent == true && remania == true)
        {
        ...
        else if(remaniaevent == false && remania == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void remanialazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void remaniashoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void remanianefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
