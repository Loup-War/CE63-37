...
public class Tanaowadee : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool tanaowadeekingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool tanaowadeeevent = false;
    public bool tanaowadee = false;
    public bool tanaowadeeinv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().tanaowadeepass == false)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "tanaowadee";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().tanaowadeepass == true)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayMoment>().visitbefore = "tanaowadee";
        ...
        {
            if (player2.GetComponent<PlayMoment>().tanaowadeepass == false)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().tanaowadeepass == true)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayMoment>().visitbefore = "tanaowadee";
        ...
        {
            if (player3.GetComponent<PlayMoment>().tanaowadeepass == false)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().tanaowadeepass == true)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayMoment>().visitbefore = "tanaowadee";
        ...
        {
            if (player4.GetComponent<PlayMoment>().tanaowadeepass == false)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().tanaowadeepass == true)
            {
                cityui.SetActive(true);
                tanaowadee = true;
                player.GetComponent<PlayMoment>().visitbefore = "tanaowadee";
    ...
    {
        if (tanaowadee == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    tanaowadeecharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "tanaowadee";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (tanaowadee == true && shoppigashop == true)
        {
    ...
    {
        if (tanaowadee == true && nefixiashop == true)
        {
    ...
    {
        if (tanaowadeeevent == true && tanaowadee == true && player.GetComponent<PlayMoment>().visitBuybefore != "tanaowadee")
        {
            inv.tanaowadeeEvent = true;
        ...
        else if (tanaowadeeevent == false && tanaowadee == true && player.GetComponent<PlayMoment>().visitBuybefore != "tanaowadee")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "tanaowadee")
        {
    ...
    void tanaowadeecharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("tanaowadeelazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("tanaowadeeshoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("tanaowadeenefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void tanaowadeelazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void tanaowadeeshoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void tanaowadeenefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void tanaowadeeConsignment(int id)
    {
        if (tanaowadeeevent == true && tanaowadeeinv == true)
        {
            inv.tanaowadeeEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (tanaowadeeevent == false && tanaowadeeinv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencitytanaowadee()
    {
        if (tanaowadee == true && tanaowadeekingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldowntanaowadeeEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfulltanaowadeeEV = true;
        }
    }
}
