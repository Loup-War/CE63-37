...
public class Audrea : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool audreakingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool audreaevent = false;
    public bool audrea = false;
    public bool audreainv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().audreapass == false)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "audrea";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().audreapass == true)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayMoment>().visitbefore = "audrea";
        ...
        {
            if (player2.GetComponent<PlayMoment>().audreapass == false)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().audreapass == true)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayMoment>().visitbefore = "audrea";
        ...
        {
            if (player3.GetComponent<PlayMoment>().audreapass == false)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().audreapass == true)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayMoment>().visitbefore = "audrea";
        ...
        {
            if (player4.GetComponent<PlayMoment>().audreapass == false)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().audreapass == true)
            {
                cityui.SetActive(true);
                audrea = true;
                player.GetComponent<PlayMoment>().visitbefore = "audrea";
    ...
    {
        if (audrea == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    audreacharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "audrea";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (audrea == true && shoppigashop == true)
        {
    ...
    {
        if (audrea == true && nefixiashop == true)
        {
    ...
    {
        if (audreaevent == true && audrea == true)
        {
            inv.audreaEvent = true;
        ...
        else if (audreaevent == false && audrea == true )
        {
            inv.RemoveItem(id);
        }
    }
    ...
    void audreacharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("audrealazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("audreashoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("audreanefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void audrealazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void audreashoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void audreanefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void audreaConsignment(int id)
    {
        if (audreaevent == true && audreainv == true)
        {
            inv.audreaEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (audreaevent == false && audreainv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencityaudrea()
    {
        if (audrea == true && audreakingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownaudreaEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullaudreaEV = true;
        }
    }
}
