...
public class Lawaek : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool lawaekkingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool lawaekevent = false;
    public bool lawaek = false;
    public bool lawaekinv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().lawaekpass == false)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "lawaek";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().lawaekpass == true)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayMoment>().visitbefore = "lawaek";
        ...
        {
            if (player2.GetComponent<PlayMoment>().lawaekpass == false)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().lawaekpass == true)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayMoment>().visitbefore = "lawaek";
        ...
        {
            if (player3.GetComponent<PlayMoment>().lawaekpass == false)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().lawaekpass == true)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayMoment>().visitbefore = "lawaek";
        ...
        {
            if (player4.GetComponent<PlayMoment>().lawaekpass == false)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().lawaekpass == true)
            {
                cityui.SetActive(true);
                lawaek = true;
                player.GetComponent<PlayMoment>().visitbefore = "lawaek";
    ...
    {
        if (lawaek == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    lawaekcharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "lawaek";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (lawaek == true && shoppigashop == true)
        {
    ...
    {
        if (lawaek == true && nefixiashop == true)
        {
    ...
    {
        if (lawaekevent == true && lawaek == true && player.GetComponent<PlayMoment>().visitBuybefore != "lawaek")
        {
            inv.lawaekEvent = true;
        ...
        else if (lawaekevent == false && lawaek == true && player.GetComponent<PlayMoment>().visitBuybefore != "lawaek")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "lawaek")
        {
    ...
    void lawaekcharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("lawaeklazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("lawaekshoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("lawaeknefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void lawaeklazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void lawaekshoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void lawaeknefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void lawaekConsignment(int id)
    {
        if (lawaekevent == true && lawaekinv == true)
        {
            inv.lawaekEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (lawaekevent == false && lawaekinv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencitylawaek()
    {
        if (lawaek == true && lawaekkingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownlawaekEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfulllawaekEV = true;
        }
    }
}
