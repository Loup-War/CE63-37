...
public class Macyros : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool macyroskingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool macyrosevent = false;
    public bool macyros = false;
    public bool macyrosinv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().macyrospass == false)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "macyros";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().macyrospass == true)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayMoment>().visitbefore = "macyros";
        ...
        {
            if (player2.GetComponent<PlayMoment>().macyrospass == false)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().macyrospass == true)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayMoment>().visitbefore = "macyros";
        ...
        {
            if (player3.GetComponent<PlayMoment>().macyrospass == false)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().macyrospass == true)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayMoment>().visitbefore = "macyros";
        ...
        {
            if (player4.GetComponent<PlayMoment>().macyrospass == false)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().macyrospass == true)
            {
                cityui.SetActive(true);
                macyros = true;
                player.GetComponent<PlayMoment>().visitbefore = "macyros";
    ...
    {
        if (macyros == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    macyroscharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "macyros";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (macyros == true && shoppigashop == true)
        {
    ...
    {
        if (macyros == true && nefixiashop == true)
        {
    ...
    {
        if (macyrosevent == true && macyros == true && player.GetComponent<PlayMoment>().visitBuybefore != "macyros")
        {
            inv.macyrosEvent = true;
        ...
        else if (macyrosevent == false && macyros == true && player.GetComponent<PlayMoment>().visitBuybefore != "macyros")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "macyros")
        {
    ...
    void macyroscharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("macyroslazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("macyrosshoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("macyrosnefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void macyroslazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void macyrosshoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void macyrosnefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void macyrosConsignment(int id)
    {
        if (macyrosevent == true && macyrosinv == true)
        {
            inv.macyrosEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (macyrosevent == false && macyrosinv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencitymacyros()
    {
        if (macyros == true && macyroskingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownmacyrosEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullmacyrosEV = true;
        }
    }
}
