...
public class Aquania : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().aquaniapass == false)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "aquania";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().aquaniapass == true)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayMoment>().visitbefore = "aquania";
        ...
        {
            if (player2.GetComponent<PlayMoment>().aquaniapass == false)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().aquaniapass == true)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayMoment>().visitbefore = "aquania";
        ...
        {
            if (player3.GetComponent<PlayMoment>().aquaniapass == false)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().aquaniapass == true)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayMoment>().visitbefore = "aquania";
        ...
        {
            if (player4.GetComponent<PlayMoment>().aquaniapass == false)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().aquaniapass == true)
            {
                cityui.SetActive(true);
                aquania = true;
                player.GetComponent<PlayMoment>().visitbefore = "aquania";
    ...
    public void BuyingLazadios(int id)
    {
        if (aquania == true && lazadioshop == true)
        {
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "aquania";
        }
    }
    ...
    {
        if (aquaniaevent == true && aquania == true && player.GetComponent<PlayMoment>().visitBuybefore != "aquania")
        {
        ...
        else if (aquaniaevent == false && aquania == true && player.GetComponent<PlayMoment>().visitBuybefore != "aquania")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "aquania")
        {
    ...
    [PunRPC]
    void aquanialazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void aquaniashoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void aquanianefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void aquaniaConsignment(int id)
    {
        if (aquaniaevent == true && aquaniainv == true)
        {
            inv.aquaniaEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (aquaniaevent == false && aquaniainv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencityaquania()
    {
        if (aquania == true && aquaniakingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownaquaniaEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullaquaniaEV = true;
        }
    }
}
