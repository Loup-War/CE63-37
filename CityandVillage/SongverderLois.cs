...
public class SongverderLois : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool songverderLoiskingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool songverderLoisevent = false;
    public bool songverderLois = false;
    public bool songverderLoisinv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().songverderLoispass == false)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "songverderLois";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().songverderLoispass == true)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayMoment>().visitbefore = "songverderLois";
        ...
        {
            if (player2.GetComponent<PlayMoment>().songverderLoispass == false)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().songverderLoispass == true)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayMoment>().visitbefore = "songverderLois";
        ...
        {
            if (player3.GetComponent<PlayMoment>().songverderLoispass == false)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().songverderLoispass == true)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayMoment>().visitbefore = "songverderLois";
        ...
        {
            if (player4.GetComponent<PlayMoment>().songverderLoispass == false)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().songverderLoispass == true)
            {
                cityui.SetActive(true);
                songverderLois = true;
                player.GetComponent<PlayMoment>().visitbefore = "songverderLois";
    ...
    {
        if (songverderLois == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    songverderLoischaring(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "songverderLois";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (songverderLois == true && shoppigashop == true)
        {
    ...
    {
        if (songverderLois == true && nefixiashop == true)
        {
    ...
    {
        if (songverderLoisevent == true && songverderLois == true && player.GetComponent<PlayMoment>().visitBuybefore != "songverderLois")
        {
            inv.songverderLoisEvent = true;
        ...
        else if (songverderLoisevent == false && songverderLois == true && player.GetComponent<PlayMoment>().visitBuybefore != "songverderLois")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "songverderLois")
        {
    ...
    void songverderLoischaring(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("songverderLoislazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("songverderLoisshoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("songverderLoisnefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void songverderLoislazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void songverderLoisshoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void songverderLoisnefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void songverderLoisConsignment(int id)
    {
        if (songverderLoisevent == true && songverderLoisinv == true)
        {
            inv.songverderLoisEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (songverderLoisevent == false && songverderLoisinv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void OpencitysongverderLois()
    {
        if (songverderLois == true && songverderLoiskingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownsongverderLoisEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullsongverderLoisEV = true;
        }
    }
}
