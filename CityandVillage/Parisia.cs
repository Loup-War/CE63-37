...
public class Parisia : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool parisiakingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool parisiaevent = false;
    public bool parisia = false;
    public bool parisiainv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().parisiapass == false)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "parisia";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().parisiapass == true)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayMoment>().visitbefore = "parisia";
        ...
        {
            if (player2.GetComponent<PlayMoment>().parisiapass == false)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().parisiapass == true)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayMoment>().visitbefore = "parisia";
        ...
        {
            if (player3.GetComponent<PlayMoment>().parisiapass == false)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().parisiapass == true)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayMoment>().visitbefore = "parisia";
        ...
        {
            if (player4.GetComponent<PlayMoment>().parisiapass == false)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().parisiapass == true)
            {
                cityui.SetActive(true);
                parisia = true;
                player.GetComponent<PlayMoment>().visitbefore = "parisia";
    ...
    {
        if (parisia == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    parisiacharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "parisia";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (parisia == true && shoppigashop == true)
        {
    ...
    {
        if (parisia == true && nefixiashop == true)
        {
    ...
    {
        if (parisiaevent == true && parisia == true && player.GetComponent<PlayMoment>().visitBuybefore != "parisia")
        {
            inv.parisiaEvent = true;
        ...
        else if (parisiaevent == false && parisia == true && player.GetComponent<PlayMoment>().visitBuybefore != "parisia")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "parisia")
        {
    ...
    void parisiacharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("parisialazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("parisiashoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("parisianefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void parisialazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void parisiashoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void parisianefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void parisiaConsignment(int id)
    {
        if (parisiaevent == true && parisiainv == true)
        {
            inv.parisiaEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (parisiaevent == false && parisiainv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencityparisia()
    {
        if (parisia == true && parisiakingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownparisiaEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullparisiaEV = true;
        }
    }
}
