...
public class Thorimberg : MonoBehaviour
{
    PhotonView pv;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        if (col.gameObject.tag == "Player1" && player1.GetComponent<PhotonView>().IsMine == true)
        {
            ...
            shopInvillage.GetComponent<VisitVillage>().thorimberg = true;
            thorimberg = true;
            openthorimberg();
        }
    ...
    void OnTriggerExit(Collider col)
    {
        if ((col.gameObject.tag == "Player1" && player1.GetComponent<PhotonView>().IsMine == true))
        {
            ...
            thorimberg = false;
            shopInvillage.GetComponent<VisitVillage>().thorimberg = false;
    ...
    void thorimbergSharing()
    {
        pv.RPC("thorimbergSharevalue", RpcTarget.AllBuffered, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7, buyitem8, buyitem9, buyitem10, buyitem11, buyitem12);
    }

    [PunRPC]
    void thorimbergSharevalue(float order1, float order2, float order3, float order4, float order5, float order6, float order7, float order8, float order9, float order10, float order11, float order12)
    {
        amount2 -= order1;
        amount3 -= order2;
        amount6 -= order3;
    ...
    public void openthorimberg()
    {
        if (thorimberg == true)
        {
            ...
            txtamount11.text = amount11.ToString() + "/60";
            txtprice11.text = (115f - (115f * cetificatevalue)).ToString();
        }
    }
    ...
    public void UseCetificate()
    {
        if (thorimberg == true)
        {
            ...
            else if (player.GetComponent<PlayMoment>().certificate[1] == 1)
            {
                cetificatevalue = 0.1f;
            ...
            else if (player.GetComponent<PlayMoment>().certificate[2] == 1)
            {
                cetificatevalue = 0.1f;
