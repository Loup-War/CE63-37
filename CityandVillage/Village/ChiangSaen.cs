...
public class ChiangSaen : MonoBehaviour
{
    PhotonView pv;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        if (col.gameObject.tag == "Player1" && player1.GetComponent<PhotonView>().IsMine == true)
        {
            ...
            shopInvillage.GetComponent<VisitVillage>().chiangSaen = true;
            chiangSaen = true;
            openchiangSaen();
        }
    ...
    void OnTriggerExit(Collider col)
    {
        if ((col.gameObject.tag == "Player1" && player1.GetComponent<PhotonView>().IsMine == true))
        {
            ...
            chiangSaen = false;
            shopInvillage.GetComponent<VisitVillage>().chiangSaen = false;
    ...
    void chiangSaenSharing()
    {
        pv.RPC("chiangSaenSharevalue", RpcTarget.AllBuffered, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7, buyitem8, buyitem9, buyitem10, buyitem11, buyitem12);
    }

    [PunRPC]
    void chiangSaenSharevalue(float order1, float order2, float order3, float order4, float order5, float order6, float order7, float order8, float order9, float order10, float order11, float order12)
    {
        amount2 -= order1;
        amount3 -= order2;
        amount6 -= order3;
    ...
    public void openchiangSaen()
    {
        if (chiangSaen == true)
        {
            ...
            txtamount9.text = amount9.ToString() + "/170";
            txtprice9.text = (20f - (20f * cetificatevalue)).ToString();
        }
    }
