...
public class Ayothaya : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool ayothayakingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool ayothayaevent = false;
    public bool ayothaya = false;
    public bool ayothayainv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().ayothayapass == false)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "ayothaya";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().ayothayapass == true)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayMoment>().visitbefore = "ayothaya";
        ...
        {
            if (player2.GetComponent<PlayMoment>().ayothayapass == false)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().ayothayapass == true)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayMoment>().visitbefore = "ayothaya";
        ...
        {
            if (player3.GetComponent<PlayMoment>().ayothayapass == false)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().ayothayapass == true)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayMoment>().visitbefore = "ayothaya";
        ...
        {
            if (player4.GetComponent<PlayMoment>().ayothayapass == false)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().ayothayapass == true)
            {
                cityui.SetActive(true);
                ayothaya = true;
                player.GetComponent<PlayMoment>().visitbefore = "ayothaya";
    ...
    {
        if (ayothaya == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    ayothayacharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "ayothaya";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (ayothaya == true && shoppigashop == true)
        {
    ...
    {
        if (ayothaya == true && nefixiashop == true)
        {
    ...
    {
        if (ayothayaevent == true && ayothaya == true && player.GetComponent<PlayMoment>().visitBuybefore != "ayothaya")
        {
            inv.ayothayaEvent = true;
        ...
        else if (ayothayaevent == false && ayothaya == true && player.GetComponent<PlayMoment>().visitBuybefore != "ayothaya")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "ayothaya")
        {
    ...
    void ayothayacharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("ayothayalazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("ayothayashoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("ayothayanefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void ayothayalazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void ayothayashoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void ayothayanefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void ayothayaConsignment(int id)
    {
        if (ayothayaevent == true && ayothayainv == true)
        {
            inv.ayothayaEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (ayothayaevent == false && ayothayainv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencityayothaya()
    {
        if (ayothaya == true && ayothayakingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownayothayaEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullayothayaEV = true;
        }
    }
}
