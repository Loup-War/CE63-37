...
public class Talukong : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool talukongkingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool talukongevent = false;
    public bool talukong = false;
    public bool talukonginv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().talukongpass == false)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "talukong";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().talukongpass == true)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayMoment>().visitbefore = "talukong";
        ...
        {
            if (player2.GetComponent<PlayMoment>().talukongpass == false)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().talukongpass == true)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayMoment>().visitbefore = "talukong";
        ...
        {
            if (player3.GetComponent<PlayMoment>().talukongpass == false)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().talukongpass == true)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayMoment>().visitbefore = "talukong";
        ...
        {
            if (player4.GetComponent<PlayMoment>().talukongpass == false)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().talukongpass == true)
            {
                cityui.SetActive(true);
                talukong = true;
                player.GetComponent<PlayMoment>().visitbefore = "talukong";
    ...
    {
        if (talukong == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    talukongcharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "talukong";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (talukong == true && shoppigashop == true)
        {
    ...
    {
        if (talukong == true && nefixiashop == true)
        {
    ...
    {
        if (talukongevent == true && talukong == true && player.GetComponent<PlayMoment>().visitBuybefore != "talukong")
        {
            inv.talukongEvent = true;
        ...
        else if (talukongevent == false && talukong == true && player.GetComponent<PlayMoment>().visitBuybefore != "talukong")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "talukong")
        {
    ...
    void talukongcharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("talukonglazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("talukongshoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("talukongnefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void talukonglazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void talukongshoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void talukongnefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void talukongConsignment(int id)
    {
        if (talukongevent == true && talukonginv == true)
        {
            inv.talukongEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (talukongevent == false && talukonginv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencitytalukong()
    {
        if (talukong == true && talukongkingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldowntalukongEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfulltalukongEV = true;
        }
    }
}
