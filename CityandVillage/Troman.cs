...
public class Troman : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool tromankingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool tromanevent = false;
    public bool troman = false;
    public bool tromaninv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().tromanpass == false)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "troman";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().tromanpass == true)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayMoment>().visitbefore = "troman";
        ...
        {
            if (player2.GetComponent<PlayMoment>().tromanpass == false)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().tromanpass == true)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayMoment>().visitbefore = "troman";
        ...
        {
            if (player3.GetComponent<PlayMoment>().tromanpass == false)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().tromanpass == true)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayMoment>().visitbefore = "troman";
        ...
        {
            if (player4.GetComponent<PlayMoment>().tromanpass == false)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().tromanpass == true)
            {
                cityui.SetActive(true);
                troman = true;
                player.GetComponent<PlayMoment>().visitbefore = "troman";
    ...
    {
        if (troman == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    tromancharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "troman";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (troman == true && shoppigashop == true)
        {
    ...
    {
        if (troman == true && nefixiashop == true)
        {
    ...
    {
        if (tromanevent == true && troman == true && player.GetComponent<PlayMoment>().visitBuybefore != "troman")
        {
            inv.tromanEvent = true;
        ...
        else if (tromanevent == false && troman == true && player.GetComponent<PlayMoment>().visitBuybefore != "troman")
        {
            inv.RemoveItem(id);
        }
        else if (player.GetComponent<PlayMoment>().visitBuybefore == "troman")
        {
    ...
    void tromancharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("tromanlazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("tromanshoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("tromannefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void tromanlazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void tromanshoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void tromannefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void tromanConsignment(int id)
    {
        if (tromanevent == true && tromaninv == true)
        {
            inv.tromanEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (tromanevent == false && tromaninv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencitytroman()
    {
        if (troman == true && tromankingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldowntromanEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfulltromanEV = true;
        }
    }
}
