...
public class Fricasia : MonoBehaviour
{
    PhotonView pv;
    ...
    public bool fricasiakingEvent;

    public Inventory inv;
    public float price;
    public float eventwood, eventrice, eventgem, eventcloth, eventarmor, eventiron;
    public bool fricasiaevent = false;
    public bool fricasia = false;
    public bool fricasiainv = false;
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        {
            if (player1.GetComponent<PlayMoment>().fricasiapass == false)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
                player.GetComponent<PlayMoment>().visitbefore = "fricasia";
                debugcity.SetActive(true);
            }
            else if (player1.GetComponent<PlayMoment>().fricasiapass == true)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayMoment>().visitbefore = "fricasia";
        ...
        {
            if (player2.GetComponent<PlayMoment>().fricasiapass == false)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player2.GetComponent<PlayMoment>().fricasiapass == true)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayMoment>().visitbefore = "fricasia";
        ...
        {
            if (player3.GetComponent<PlayMoment>().fricasiapass == false)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player3.GetComponent<PlayMoment>().fricasiapass == true)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayMoment>().visitbefore = "fricasia";
        ...
        {
            if (player4.GetComponent<PlayMoment>().fricasiapass == false)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayerMoney>().money -= 300;
            ...
            else if (player4.GetComponent<PlayMoment>().fricasiapass == true)
            {
                cityui.SetActive(true);
                fricasia = true;
                player.GetComponent<PlayMoment>().visitbefore = "fricasia";
    ...
    {
        if (fricasia == true && lazadioshop == true)
        {
            if (id == 0 && inv.valuee <= amountlaza2)//ไม้
            {
                if (player.GetComponent<PlayerMoney>().money >= (inv.valuee * (20 - (20 * eventwood))) && inv.weightall + (inv.valuee * 2) <= 300)
                {
                    ...
                    fricasiacharing(laza, shoppi, nefi);
            ...
            inv.valuee = 1;
            laza = false;
            player.GetComponent<PlayMoment>().visitBuybefore = "fricasia";
        }
    }
    public void BuyingShoppiga(int id)
    {
        if (fricasia == true && shoppigashop == true)
        {
    ...
    {
        if (fricasia == true && nefixiashop == true)
        {
    ...
    {
        if (fricasiaevent == true && fricasia == true )
        {
            inv.fricasiaEvent = true;
        ...
        else if (fricasiaevent == false && fricasia == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    void fricasiacharing(bool lazadi, bool shoppic, bool nefixi)
    {
        if (lazadi == true)
        {
            pv.RPC("fricasialazadio", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (shoppic == true)
        {
            pv.RPC("fricasiashoppica", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
        else if (nefixi == true)
        {
            pv.RPC("fricasianefixia", RpcTarget.All, buyitem1, buyitem2, buyitem3, buyitem4, buyitem5, buyitem6, buyitem7);
        }
    }

    [PunRPC]
    void fricasialazadio(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
    ...
    [PunRPC]
    void fricasiashoppica(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void fricasianefixia(float order1, float order2, float order3, float order4, float order5, float order6, float order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
    ...
    public void fricasiaConsignment(int id)
    {
        if (fricasiaevent == true && fricasiainv == true)
        {
            inv.fricasiaEvent = true;
            inv.eventrice = eventrice;
            inv.eventiron = eventiron;
        ...
        else if (fricasiaevent == false && fricasiainv == true)
        {
            inv.Consignmentcell(id);
        }
    }

    public void Opencityfricasia()
    {
        if (fricasia == true && fricasiakingEvent == true)
        {
    ...
    public void Cooldownitem()
    {
        if (amountlaza1 < 250 || amountlaza2 < 170 || amountlaza3 < 100 || amountlaza4 < 60 || amountlaza5 < 35 || amountlaza6 < 10 || amountlaza7 < 5 ||
            ...
            mainEventsys.GetComponent<MainEventSys>().CooldownfricasiaEV == 0)
        {
            mainEventsys.GetComponent<MainEventSys>().notfullfricasiaEV = true;
        }
    }
}
