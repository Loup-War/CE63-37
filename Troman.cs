...
public class Troman : MonoBehaviour
{
    ...
    {
        if (tromanevent == true && troman == true)
        {
        ...
        else if(troman == true && tromanevent == false)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void tromanlazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void tromanshoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void tromannefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
