...
public class Talukong : MonoBehaviour
{
    ...
    {
        if (talukongevent == true && talukong == true)
        {
        ...
        else if(talukongevent == false && talukong == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void talukonglazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void talukongshoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void talukongnefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
