...
public class Macyros : MonoBehaviour
{
    ...
    {
        if (macyrosevent == true && macyros == true)
        {
        ...
        else if(macyrosevent == false && macyros == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void macyroslazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void macyrosshoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void macyrosnefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
