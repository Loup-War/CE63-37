...
public class Parisia : MonoBehaviour
{
    ...
    {
        if (parisiaevent == true && parisia == true)
        {
        ...
        else if(parisiaevent == false && parisia == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void parisialazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void parisiashoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void parisianefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
