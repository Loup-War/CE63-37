...
public class Lawaek : MonoBehaviour
{
    ...
    {
        if (lawaekevent == true && lawaek == true)
        {
        ...
        else if(lawaekevent == false && lawaek == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void lawaeklazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void lawaekshoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void lawaeknefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
