...
public class Jenla : MonoBehaviour
{
    ...
    [PunRPC]
    void jenlaSharevalue(int order1, int order2, int order3, int order4, int order5, int order6, int order7, int order8, int order9, int order10, int order11, int order12)
    {
        amount2 -= order1;
        amount3 -= order2;
        amount6 -= order3;
