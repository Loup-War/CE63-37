...
public class Ayothaya : MonoBehaviour
{
    ...
    {
        if (ayothaya == true && ayothaya == true)
        {
            ...
            inv.eventgem = eventgem;
            inv.RemoveItem(id);
        }
        else if(ayothaya == false && ayothaya == true)
        {
            inv.RemoveItem(id);
        }
    }
    ...
    [PunRPC]
    void ayothayalazadio(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
    ...
    [PunRPC]
    void ayothayashoppica(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountshopp2 -= order1;
        amountshopp3 -= order2;
        amountshopp6 -= order3;
    ...
    [PunRPC]
    void ayothayanefixia(int order1, int order2, int order3, int order4, int order5, int order6, int order7)
    {
        amountnef2 -= order1;
        amountnef3 -= order1;
        amountnef6 -= order3;
